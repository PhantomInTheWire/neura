...
3.  **For Each Main Section:**
    ...
    *   **Mandatory Association:** If you reference an image filename (e.g., `img_1_0.png`) within the `explanation` text for a subsection, you MUST include that exact filename string in the `associated_image_filenames` list for that same subsection.
